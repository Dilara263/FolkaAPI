...
namespace FolkaAPI.Migrations
{
    ...
    [Migration("20250819103608_AddUsersTable")]
            ...
            modelBuilder.Entity("FolkaAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Dilara",
                            PasswordHash = "$2a$11$/9Z/DxO.BO4rod6TXoqgYugWuJYvSuuRXVrRbQAyjWwkjTkv8d/yq",
                        ...
                        new
                        {
                            ...
                            Email = "test@user.com",
                            Name = "Test User",
                            PasswordHash = "$2a$11$DQPPsfBdhW2iqGME7qErI.sfuht8pgwnSNYMogMJIWE6dUNUP7r2a"
                        });
                });
